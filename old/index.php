...
/**
SELECT t1.name, CASE WHEN t2.ref_id IS NOT NULL THEN 1 ELSE 0 END AS landed FROM Tricks t1 LEFT JOIN UserTricks t2 ON t1.g_id = t2.ref_id AND t2.owner_id = 11 WHERE t1.invisible = 0;
**/
function GetTrickNamesForUser() {
	global $mysql, $account_id;
